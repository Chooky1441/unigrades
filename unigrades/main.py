...
import home_screen, create_schedule, schedule_screen, course_screen, assignment_screen, utils
...
class MainScreen(ScreenManager):
    def __init__(self, **kwargs):
        ...
        utils.SCREENS = {'home_screen': self._home_screen, 'create_screen': self._create_screen, 'schedule_screen': self._schedule_screen,
                         'course_screen': self._course_screen, 'assignment_screen': self._assignment_screen}
